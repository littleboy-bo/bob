...
import cn.com.bob.learn.base.handle.BobHandler;
import cn.com.bob.learn.base.headerHandler.HeaderProcessor;
import cn.com.bob.learn.base.thread.LocalThreadManager;
import cn.com.bob.learn.base.util.DateUtils;
import cn.com.bob.learn.base.util.MdcUtils;
import cn.com.bob.learn.base.util.SeqUtils;
    ...
    private void writeResponse(Map result, HttpServletResponse response) throws ServletException, UnsupportedEncodingException, IOException {
        ...
        if (result != null) {
            try {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("请求路径: {}, 响应头 ZY-Head:{}, 响应头状态码为 :{}", "111111", JSONObject.toJSONString(sysHead), 200);
                }
